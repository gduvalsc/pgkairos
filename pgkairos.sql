...
RETURNS text AS $$
	...
	schema['vkpg_stat_activity'] = dict(timestamp="text", snap_frequency="real", application_name="text", backend_start="text", backend_xid="text", backend_xmin="text", client_addr="text", client_hostname="text", client_port="text", datid="text", datname="text", pid="text", hash="text", query="text", query_start="text", snap="text", state="text", state_change="text", usename="text", usesysid="text", wait_event="text", wait_event_type="text", xact_start="text")
